...
const mapStateToProps = (state) => ({
  loading: state.pages.myposts.loading,
  items: state.pages.myposts.items,
  pages: state.pages.myposts.pages,
  current_page: state.pages.myposts.current_page,
});
